...
const NewsLetter = () => {
  ...
  return (
    <section className="max_padd_container py-12 xl:py-28 bg-gradient-to-b from-blue-100 to-blue-200">
      <div className="mx-auto xl:w-[80%] flexCenter flex-col gap-y-8 w-full max-w-[666px]">
        <h3 className="text-center text-3xl lg:text-4xl font-bold text-gray-800 mb-4">Get Exclusive Offers in Your Inbox</h3>
        <h4 className="text-center uppercase text-lg font-semibold text-gray-700 mb-8">Subscribe to our newsletter and stay updated</h4>
